...
use threshold_signatures::{confidential_key_derivation as ckd, frost_ed25519, frost_secp256k1};

use contract_interface::types::{self as dtos, ParsePublicKeyError};
...
#[allow(dead_code)] // Used when converting DTOs to node types (e.g. for key import)
    ...
    fn try_into_node_type(self) -> Result<frost_secp256k1::VerifyingKey, ParsePublicKeyError> {
        ...
        Ok(frost_secp256k1::VerifyingKey::new(
            k256::ProjectivePoint::from_encoded_point(&point)
                .into_option()
                .ok_or(ParsePublicKeyError::InvalidKeyLength)?,
        ))
    }
}
...
impl TryIntoNodeType<ed25519_dalek::VerifyingKey> for contract_interface::types::Ed25519PublicKey {
    ...
    fn try_into_node_type(self) -> Result<ed25519_dalek::VerifyingKey, ParsePublicKeyError> {
        ed25519_dalek::VerifyingKey::from_bytes(self.as_bytes())
            .map_err(|_| ParsePublicKeyError::InvalidKeyLength)
    }
}
