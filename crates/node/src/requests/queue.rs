    ...
    PendingRequests<RequestType, ChainRespondArgsType>
{
    ...
    pub fn notify_new_block(
        ...
        let (
            ...
            types::RequestType::DilithiumKeyRegistration => (
                &metrics::MPC_PENDING_DILITHIUM_KEY_REGISTRATIONS_QUEUE_BLOCKS_INDEXED,
                &metrics::MPC_PENDING_DILITHIUM_KEY_REGISTRATIONS_QUEUE_FINALIZED_BLOCKS_INDEXED,
                &metrics::MPC_PENDING_DILITHIUM_KEY_REGISTRATIONS_QUEUE_RESPONSES_INDEXED,
                &metrics::MPC_PENDING_DILITHIUM_KEY_REGISTRATIONS_QUEUE_MATCHING_RESPONSES_INDEXED,
                &metrics::DILITHIUM_KEY_REGISTRATION_REQUEST_RESPONSE_LATENCY_BLOCKS,
                &metrics::DILITHIUM_KEY_REGISTRATION_REQUEST_RESPONSE_LATENCY_SECONDS,
                &metrics::MPC_PENDING_DILITHIUM_KEY_REGISTRATIONS_QUEUE_REQUESTS_INDEXED,
            ),
        };
    ...
    pub fn get_requests_to_attempt(
        ...
        let (mpc_pending_requests_queue_size, mpc_pending_requests_queue_attempts_generated) =
            match RequestType::get_type() {
                ...
                types::RequestType::DilithiumKeyRegistration => (
                    &metrics::MPC_PENDING_DILITHIUM_KEY_REGISTRATIONS_QUEUE_SIZE,
                    &metrics::MPC_PENDING_DILITHIUM_KEY_REGISTRATIONS_QUEUE_ATTEMPTS_GENERATED,
                ),
            };
