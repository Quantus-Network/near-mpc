...
impl DilithiumDerivedShareStorage {
    ...
    pub fn load_all_for_domain(
    ...
    ) -> anyhow::Result<Vec<(crate::providers::dilithium::DerivedKeyId, crate::providers::dilithium::DilithiumKeygenOutput)>> {
        ...
        for item in self.db.iter_range(DBCol::DilithiumDerivedShare, &start_key, &end_key) {
    ...
    fn parse_key(key: &[u8]) -> Option<crate::providers::dilithium::DerivedKeyId> {
        ...
        let domain_id = mpc_contract::primitives::domain::DomainId(
